class CustomersController < ApplicationController
  ...
  private
    ...
    def customer_params
      params.require(:customer).permit(:company_name, :first_name, :last_name, :civility, :address, :country_id, :city, :phone, :street, :email, :po_box, :zip_code, :description, :status)
    end
end
